...
function App() {
  return (
    ...
    //   </div>
    //   <Routes>
    //     {/* Các Route khác, định nghĩa các tuyến đường */}
    ...
    //     {/* Có thể thêm route mặc định cho trang chủ */}
    ...
    //             <Link to="/nhapTTBenhNhan">Bệnh Nhân</Link>
    //             <Link to="/nhapTTBacSi">Bác sĩ</Link>
    //             <Link to='/nhapTTBenhAn'>Bệnh án</Link>
    //           </div>
    //         </nav>
    //       </div>
